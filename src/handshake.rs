    ...
    fn make_tls_crypto_info(
        ...
        let tls_crypto_info = libc::tls_crypto_info {
            version: match protocol_version {
                ...
                protocol_version => unreachable!("expected OpenSSL to negotiate TLS 1.2 or 1.3 because of prepare_for_ktls but it negotiated {protocol_version:?}"),
            },
...
pub(crate) fn rustls_prepare<TConfig>(
    config_builder: rustls::ConfigBuilder<TConfig, rustls::WantsCipherSuites>,
    tls_allowed: (bool, bool),
    cipher_suites_allowed: (bool, bool, bool),
...
pub(crate) fn rustls(
    ...
    fn make_tls_crypto_info(
        ...
        let tls_crypto_info = libc::tls_crypto_info {
            version: match protocol_version {
                ...
                protocol_version => unreachable!("expected rustls to negotiate TLS 1.2 or 1.3 because of prepare_for_ktls but it negotiated {protocol_version:?}"),
            },
    ...
    let ExtractedSecrets { tx, rx } = conn.extract_secrets().unwrap();
